...
import Harvardtean from "./Harvardtean";
import Why from "./Why";
import Studentrw from "./Studentrw";
...
<button className='book_now_free'>Book Now</button> */}
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className='svg_front_lower' viewBox="0 0 1440 320"><path fill="#1287fa" fill-opacity="1" d="M0,160L80,144C160,128,320,96,480,106.7C640,117,800,171,960,192C1120,213,1280,203,1360,197.3L1440,192L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
      ...
      <blockquote className="quote_div quote_div_bordered quoted">
        ...
        <p className="quote_credit"> Elon Musk</p>
      </blockquote>
...
{/* 
      ...
      <div className='reason'><Why></Why></div>
...
<div className=''><Studentrw></Studentrw></div>
