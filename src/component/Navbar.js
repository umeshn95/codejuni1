        ...
        <input type="checkbox" id="drop" />
            <ul class="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><Link to='/champ'>Coding Champ(Grade 1 to 6)</Link></li>
                        <li><Link to='/master'>Coding Master(Grade 7 to 10)</Link></li>
                        <li><Link to='/pro'>Coding Champ(Grade 11 to 12)</Link></li>
                    </ul> 
